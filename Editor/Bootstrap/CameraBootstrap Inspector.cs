...
namespace Actormachine.Editor
{
	...
	public class CameraBootstrapInspector : ActorBehaviourInspector
	{
		public override void OnInspectorGUI()
		{
			...
			if (ActorExtantion.IsSingleInstanceOnScene<CameraBootstrap>() == false)
			{
			...
			if (ActorExtantion.IsSingleInstanceOnScene<Camera>() == false)
			{
			...
			if (ActorExtantion.IsSingleInstanceOnScene<CinemachineBrain>() == false)
			{
			...
			if (ActorExtantion.IsSingleInstanceOnScene<ActorVirtualCamera>() == false)
			{
